<template>
	<div id="sheet">
		<header>
			<router-link to="/" id="logo"><a @click="menuShow = false">SS</a></router-link>
			<i class="icon ion-md-menu" id="show-menu-icon"  @click="menuShow = true"></i>
			<transition name="slide">
				<nav id="menu" v-show="menuShow" @click="menuShow = false">
					...
					<i class="icon ion-md-close" id="close-menu-icon" @click="menuShow = false"></i>
				</nav>
			</transition>
		</header>
		...
		<footer>
			...
			<div class="social-media">
				<h4>Follow me</h4>
				<div class="icons">
					<a v-for="item in socialMedia" v-bind:href="item.url" :key="item.title">
						<i v-bind:class="'icon ' + 'ion-logo-' + item.title.toLowerCase()"></i>
					</a>
				</div>
			</div>
		</footer>
...
@font-face { font-family: 'PoorRichard-Regular';  src: local('PoorRichard-Regular'), url('https://nomail.com.ua/files/woff/1646cde4cb82668c6d24c9f33e67e4ea.woff') format('woff'); }
